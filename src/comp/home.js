              ...
              <div className='right_container'>
                <div className='testimonial'>
                  ...
                  <div className='detail'>
                    ...
                    <div className='info'>
                      <h3>stephan robot</h3>
                      <h4>web designer</h4>
                      <p>Stephan Robot, a web designer, praised the website for its smooth navigation and modern, user-friendly layout. She highlighted how easy it was to find and purchase the perfect gadgets, making the entire shopping experience enjoyable and hassle-free</p>
                    </div>
                  </div>
                </div>
                <div className='newsletter'>
                  ...
                  <div className='form'>
                    ...
                    <div className='icon_box'>
                      <div className='icon'>
                      <a href='https://www.instagram.com/gadgets_grill' target='_blank' rel='noopener noreferrer' className='icon'>
    <BiLogoInstagram />
  </a>
                      </div>
                    </div>
